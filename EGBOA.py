...
# Enhanced Gooseneck Barnacle Optimization Algorithm (GBOA) Stating Line No. 66
def EGBOA(X, objective, lb, ub, max_iter):
    ...
    for it in range(max_iter):
        ...
        for i in range(pop_size):
            ...
            r = CurrentFit / BestFit + WorstFit
            # target dimension (move toward best)
            T_dim = (GlobalBest - Xi) * r
